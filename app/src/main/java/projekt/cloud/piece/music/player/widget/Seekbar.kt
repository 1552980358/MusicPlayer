...
class Seekbar(context: Context, attributeSet: AttributeSet?): View(context, attributeSet) {
    ...
    private val lineRadius by lazy { resources.getDimension(R.dimen.progressbar_indicator_thick) }
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        if (getMode(heightMeasureSpec) != EXACTLY) {
            return setMeasuredDimension(MeasureSpec.getSize(widthMeasureSpec), resources.getDimensionPixelSize(R.dimen.seekbar_wrap_height))
        }
