...
import projekt.cloud.piece.music.player.util.BitmapUtil.heightF
import projekt.cloud.piece.music.player.util.BitmapUtil.widthF
...
class CropImageView(context: Context, attributeSet: AttributeSet?): View(context, attributeSet) {
    ...
    init {
        context.theme.obtainStyledAttributes(attributeSet, R.styleable.CropImageView, 0, 0).apply {
            cropPaint.strokeWidth = getDimension(
                R.styleable.CropImageView_lineThickness,
                resources.getDimension(R.dimen.crop_image_view_default_line_width)
            )
            circleRadius = getDimension(
                R.styleable.CropImageView_circleRadius,
                resources.getDimension(R.dimen.crop_image_view_default_circle_radius)
            )
            minSize = getDimension(
                R.styleable.CropImageView_minSize,
                resources.getDimension(R.dimen.crop_image_view_default_min_size)
            )
        }
